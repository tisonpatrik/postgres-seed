...
def load_and_rename_columns(file_path: str, column_mapping: dict = None) -> pd.DataFrame:
    """
    ...
    for file_name in os.listdir(directory_path):
        if file_name.endswith('.csv'):
            ...
            try:
                ...
                agregated = aggregate_to_day_based_prices(loaded,index_column=date_time,price_column=price)
